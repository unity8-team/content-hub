...
class AppManager: public com::ubuntu::ApplicationManager::ApplicationManager
{
  public:
    ...
    virtual bool invoke_application_with_instance(const std::string &app_id, const std::string &instance_id, gchar ** uris);
    virtual std::string invoke_application_with_session(const std::string &app_id, PromptSessionP session, gchar ** uris);
    virtual bool stop_application_with_helper(const std::string &app_id, const std::string &instance_id);
