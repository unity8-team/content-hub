...
class AppManager: public com::ubuntu::ApplicationManager::ApplicationManager
{
  public:
    ...
    virtual bool invoke_application_with_session(const std::string &app_id, const PromptSessionP &session);
    virtual bool stop_application_with_helper(const std::string &app_id);
